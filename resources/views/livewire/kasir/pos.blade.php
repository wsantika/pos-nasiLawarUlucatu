    ...
    @if ($showPaymentModal)
        <div class="fixed inset-0 z-50 overflow-y-auto">
            <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
                <div class="fixed inset-0 transition-opacity bg-slate-900 bg-opacity-50" wire:click="closePaymentModal"></div>
                    ...
                    <form wire:submit.prevent="processPayment">
                        ...
                        <div class="bg-white px-6 py-4 space-y-4">
                            <div class="bg-slate-50 p-4 rounded-lg">
                                ...
                                <p class="text-3xl font-bold text-slate-900">Rp {{ number_format($total, 0, ',', '.') }}</p>
                            </div>
                            ...
                            @if ($change > 0)
                                <div class="bg-green-50 p-4 rounded-lg border border-green-200">
                                    ...
                                    <p class="text-2xl font-bold text-green-900">Rp {{ number_format($change, 0, ',', '.') }}</p>
                                </div>
                            @endif
